  ...
  .. tab-item:: Added
    ...
    .. list-table::
        ...
        * - Migrate to using \`\`.safety-ignore.yml\`\` file
          - `#1215 <https://github.com/ansys/actions/pull/1215>`_
  ...
  .. tab-item:: Maintenance
    ...
    .. list-table::
        ...
        * - Update migration guide for v10.2.12 patch
          - `#1245 <https://github.com/ansys/actions/pull/1245>`_


`10.2.11 <https://github.com/ansys/actions/releases/tag/v10.2.11>`_ - March 27, 2026
====================================================================================
  ...
  .. tab-item:: Added
    ...
    .. list-table::
        ...
        * - Release-github option to control PDF/HTML doc upload
          - `#1236 <https://github.com/ansys/actions/pull/1236>`_


`10.2.10 <https://github.com/ansys/actions/releases/tag/v10.2.10>`_ - March 24, 2026
====================================================================================
  ...
  .. tab-item:: Fixed
    ...
    .. list-table::
        ...
        * - Use token input consistently
          - `#1222 <https://github.com/ansys/actions/pull/1222>`_
  ...
  .. tab-item:: Fixed
    ...
    .. list-table::
        ...
        * - Upload artifacts even if failure happens before (when requested)
          - `#1134 <https://github.com/ansys/actions/pull/1134>`_


`10.2.4 <https://github.com/ansys/actions/releases/tag/v10.2.4>`_ - December 09, 2025
=====================================================================================
  ...
  .. tab-item:: Added
    ...
    .. list-table::
        ...
        * - Add opt-in inputs to fetch full git history & tags for versioning
          - `#1024 <https://github.com/ansys/actions/pull/1024>`_

        * - Fall back to inputs.token for PACKAGE_DELETION_TOKEN
          - `#1035 <https://github.com/ansys/actions/pull/1035>`_

        * - Improve-doc-deploy-pr
          - `#1045 <https://github.com/ansys/actions/pull/1045>`_
  ...
  .. tab-item:: Dependencies
    ...
    .. list-table::
        ...
        * - Bump the build-related-actions group across 1 directory with 2 updates
          - `#846 <https://github.com/ansys/actions/pull/846>`_, `#1063 <https://github.com/ansys/actions/pull/1063>`_
        ...
        * - Bump the build-related-actions group across 2 directories with 1 update
          - `#865 <https://github.com/ansys/actions/pull/865>`_, `#914 <https://github.com/ansys/actions/pull/914>`_, `#1054 <https://github.com/ansys/actions/pull/1054>`_
        ...
        * - Bump peter-evans/find-comment from 3.1.0 to 4.0.0 in /_pr-doc-deployment in the must-be-assigned-actions group across 1 directory
          - `#1034 <https://github.com/ansys/actions/pull/1034>`_

        * - Bump docker/login-action from 3.4.0 to 3.6.0 in /.github/workflows in the test-related-actions group across 1 directory
          - `#1039 <https://github.com/ansys/actions/pull/1039>`_

        * - Bump the github-actions group across 1 directory with 3 updates
          - `#1040 <https://github.com/ansys/actions/pull/1040>`_

        * - Bump pypa/cibuildwheel from 3.2.0 to 3.2.1 in /build-ci-wheels in the build-related-actions group across 1 directory
          - `#1041 <https://github.com/ansys/actions/pull/1041>`_

        * - Bump the release-related-actions group across 2 directories with 1 update
          - `#1042 <https://github.com/ansys/actions/pull/1042>`_

        * - Bump the github-actions group across 12 directories with 2 updates
          - `#1053 <https://github.com/ansys/actions/pull/1053>`_

        * - Bump the github-actions group across 18 directories with 1 update
          - `#1069 <https://github.com/ansys/actions/pull/1069>`_
  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Updating parameter documentation
          - `#1027 <https://github.com/ansys/actions/pull/1027>`_

        * - Fix typo in \`\`vulnerability-actions/index.rst\`\`
          - `#1030 <https://github.com/ansys/actions/pull/1030>`_

        * - Update guidelines to report vulnerabilities
          - `#1043 <https://github.com/ansys/actions/pull/1043>`_

        * - Provide extra hint on enabling artifact attestation notes in \`\`ansys/actions/release-github\`\`
          - `#1044 <https://github.com/ansys/actions/pull/1044>`_

        * - Clarify the behaviour of \`hk-package-clean-except\` action
          - `#1058 <https://github.com/ansys/actions/pull/1058>`_

        * - Docs: update migration guide
          - `#1076 <https://github.com/ansys/actions/pull/1076>`_
  ...
  .. tab-item:: Fixed
    ...
    .. list-table::
        ...
        * - Alignment of inputs passed to check-licenses from wheelhouse build
          - `#1055 <https://github.com/ansys/actions/pull/1055>`_

        * - Add a comment when pr documentation is removed
          - `#1064 <https://github.com/ansys/actions/pull/1064>`_

        * - Avoid rendering empty artifact attestation
          - `#1065 <https://github.com/ansys/actions/pull/1065>`_

        * - Pyansys-geometry doc-build test
          - `#1067 <https://github.com/ansys/actions/pull/1067>`_

        * - Dependabot coverage job
          - `#1072 <https://github.com/ansys/actions/pull/1072>`_
  ...
  .. tab-item:: Maintenance
    ...
    .. list-table::
        ...
        * - Update CHANGELOG for v10.0.16
          - `#980 <https://github.com/ansys/actions/pull/980>`_

        * - Update CHANGELOG for v10.0.17
          - `#984 <https://github.com/ansys/actions/pull/984>`_

        * - Update CHANGELOG for v10.0.19
          - `#987 <https://github.com/ansys/actions/pull/987>`_

        * - Update CHANGELOG for v10.0.20
          - `#990 <https://github.com/ansys/actions/pull/990>`_

        * - Update CHANGELOG for v10.1.0rc0
          - `#997 <https://github.com/ansys/actions/pull/997>`_

        * - Update CHANGELOG for v10.1.1
          - `#1004 <https://github.com/ansys/actions/pull/1004>`_

        * - Update CHANGELOG for v10.1.2
          - `#1008 <https://github.com/ansys/actions/pull/1008>`_

        * - Update CHANGELOG for v10.1.3
          - `#1013 <https://github.com/ansys/actions/pull/1013>`_

        * - Bump zizmor version to 1.16.0
          - `#1016 <https://github.com/ansys/actions/pull/1016>`_

        * - Update CHANGELOG for v10.1.4
          - `#1022 <https://github.com/ansys/actions/pull/1022>`_

        * - Fix geometry runs
          - `#1025 <https://github.com/ansys/actions/pull/1025>`_

        * - Fix dependabot settings
          - `#1037 <https://github.com/ansys/actions/pull/1037>`_

        * - Update CHANGELOG for v10.1.5
          - `#1049 <https://github.com/ansys/actions/pull/1049>`_

        * - Add job to check dependabot configuration coverage
          - `#1056 <https://github.com/ansys/actions/pull/1056>`_

        * - Update missing or outdated files
          - `#1071 <https://github.com/ansys/actions/pull/1071>`_

        * - Updating dependabot.yml with missing actions
          - `#1074 <https://github.com/ansys/actions/pull/1074>`_
  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - Refactor: \`use-pull-request-title\` instead of \`use-conventional-commits\`
          - `#962 <https://github.com/ansys/actions/pull/962>`_
  ...
  .. tab-item:: Test
    ...
    .. list-table::
        ...
        * - Update external package tests
          - `#1032 <https://github.com/ansys/actions/pull/1032>`_


`10.1.5 <https://github.com/ansys/actions/releases/tag/v10.1.5>`_ - October 31, 2025
====================================================================================
  ...
  .. tab-item:: Fixed
    ...
    .. list-table::
        ...
        * - Check-licenses in build-wheelhouse
          - `#1046 <https://github.com/ansys/actions/pull/1046>`_
