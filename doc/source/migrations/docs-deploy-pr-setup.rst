...
.. note::
  ...
  If a dedicated bot token is used instead, this workflow ``permissions`` requirement is not needed.
...
.. tab-set::
  ...
  .. tab-item:: For versions prior to v10.2
  ...
  .. tab-item:: For versions after v10.2
...
2. **Setup with Labeling Strategy**
   ...
   For an example, see `this setup <https://github.com/ansys/actions/pull/1045/files>`_ for
   ``ansys/actions``.